      ...
      <div className="bg-white w-screen h-screen fixed">
        ...
        <div className="bg-[#950101] w-[870px] h-[160px] mx-[100px] my-[-46px] rounded-xl">
          ...
          <div className="flex justify-between items-center mt-3 mx-7">
            <div className="bg-black bg-opacity-50 w-[62px] h-[96px] rounded-3xl">
              <div className="flex flex-col items-center gap-2">
                <div className="text-white text-center w-[40px]">SEN</div>
                <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                  4
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">SEL</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                5
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">RAB</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                6
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">KAM</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                7
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">JUM</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                8
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">SAB</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                9
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-white text-center w-[40px]">MIN</div>
              <div className="text-white text-center text-3xl rounded-lg  py-2  w-[40px]">
                10
              </div>
            </div>
