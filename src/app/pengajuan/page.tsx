      ...
      <div className="bg-white w-screen h-screen fixed">
        ...
        <div className="flex justify-center my-7">
          <div className="flex flex-col gap-4">
            ...
            <form className="relative">
              <div className="relative">
                ...
                <input
                  type="text"
                  id="Keterangan"
                  className="bg-white border-2 border-[#4E4E4E] text-black rounded-lg w-[400px] h-[136px] pl-14"
            ...
            <button className="bg-[#950101] w-[110px] h-[40px] text-white font-medium rounded-l-xl rounded-r-xl text-sm my-">
              Kirim
             </button>
