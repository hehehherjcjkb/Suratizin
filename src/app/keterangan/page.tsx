        ...
        <div className="flex flex-col items-center mt-16">
          <div className="flex flex-col gap-2">
            ...
            <div className="bg-[#999999] rounded-xl bg-opacity-60 w-[841px] h-[52px] flex justify-center items-center relative">
              <IoMdArrowBack className="absolute left-9"></IoMdArrowBack>
          ...
          <div className="flex flex-col gap-4">
            ...
            <form className="relative">
              <div className="relative">
                ...
                <div className="bg-white border-2 border-[#4E4E4E] text-black rounded-lg w-[400px] h-[136px] pl-14 flex items-center text-sm">
            ...
            <div className="flex flex-row gap-11 justify-center text-sm my-10">
              <button className="bg-[#950101] w-[103px] h-[35px] text-white font-medium rounded-l-xl rounded-r-xl">
                Ditolak
              </button>
              <button className="bg-[#950101] w-[103px] h-[35px] text-white font-medium rounded-l-xl rounded-r-xl">
                Diterima
